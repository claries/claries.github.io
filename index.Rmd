...
The best model consider cyl,hp, wt as cofunders with am, and it explained `r round(summary(fitBest)$r.squared,4) * 100`% of the variance in MPG. This model is better than the simple regression model (p<0.0001). And in this model, manual cars also get better MPG, about `r round(fitBest$coefficients[6],2)` higher than automatic ones.
```{r,results='hold',echo=FALSE}
anova(fit,fitBest)
```
